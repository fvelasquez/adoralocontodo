...
<head>
	...
	<style>
		body { background: url(images/sendform2_bg.png) no-repeat top left; font-size: 11px; font-family: Helvetica, Arial, Verdana; color: white; }
...
<div style="width:500px; margin:120px auto 0px; font-size:14px;">
	<ol>
		<li>Sube tu video a youtube, vimeo</li>
		...
		<li>Publica tu adoraci&oacute;n para que todos puedan verla y adorarlo con todo!</li>
	</ol>
</div>
...
<form method="post" action="savemedia.php" style="width:500px;margin:50px auto 0; display:none;" id="sm_sendmedia">
	...
	<input type="hidden" name="contest" id="contest" value="true" />
